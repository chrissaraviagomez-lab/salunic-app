...
class FormRegistro(tk.Frame):
    ...
    def create_progress(self):
        ...
        self.canvas.create_rectangle(154.09, 127, 279.18, 132, fill="#ffffff", outline="")
        self.canvas.create_rectangle(286.18, 127, 411, 132, fill="#ffffff", outline="")
    ...
    def create_title(self):
        ...
        self.canvas.create_text(22, 120, text="Completa tu información personal para comenzar en Salunic",
                               font=("Nunito", 12.5), fill="#ffffff")
    
    def create_form_fields(self):
        # Foto de perfil
        self.canvas.create_oval(22, 175, 82, 235, fill="#ffffff", outline="")
        ...
        self.canvas.create_text(22, 262, text="NOMBRE *", font=("Nunito", 10.5, "bold"),
                               fill="#ffffff")
        self.canvas.create_rectangle(22, 285, 162.5, 319, fill="#ffffff", outline="",
                                   width=0)
        ...
        self.canvas.create_text(182.5, 262, text="APELLIDO *", font=("Nunito", 10.5, "bold"),
                               fill="#ffffff")
        self.canvas.create_rectangle(182.5, 285, 323, 319, fill="#ffffff", outline="",
                                   width=0)
        ...
        self.canvas.create_text(22, 334, text="CORREO ELECTRÓNICO *", font=("Nunito", 10.5, "bold"),
                               fill="#ffffff")
        self.canvas.create_rectangle(22, 357, 353, 391, fill="#ffffff", outline="",
                                   width=0)
        ...
        self.canvas.create_text(22, 416, text="TELÉFONO *", font=("Nunito", 10.5, "bold"),
                               fill="#ffffff")
        self.canvas.create_rectangle(22, 439, 353, 473, fill="#ffffff", outline="",
                                   width=0)
        ...
        self.canvas.create_text(57, 560, text="Acepto los términos y condiciones y la política de privacidad de Salunic",
                               font=("Nunito", 12), fill="#ffffff", anchor="nw", width=278)
